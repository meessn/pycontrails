...
file_path = 'P3T3_SLS_GRAPHS_GTF2035_final.csv'  # Replace with the actual file path
...
interp_func_FGR = interp1d(TT3, FGR, kind='linear')
...
functions = {'interp_func_far': interp_func_FAR, 'interp_func_pt3': interp_func_PT3, 'interp_func_fgr': interp_func_FGR}
#save interpolation functions
with open('p3t3_graphs_sls_gtf2035_final.pkl', 'wb') as f:
