...
file_path = 'P3T3_SLS_GRAPHS_PW1921G.csv'  # Replace with the actual file path
...
TT3_query = 600  # Replace with your desired TT3 value
...
with open('p3t3_graphs_sls_1921.pkl', 'wb') as f:
