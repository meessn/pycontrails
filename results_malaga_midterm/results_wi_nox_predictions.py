...
plt.plot(df_gsp.index, df_gsp['EI_nox_p3t3'], label='P3T3 Kaiser Correction', linestyle='-', marker='o', markersize=2.5)
plt.plot(df_gsp.index, df_gsp['EI_nox_p3t3_xue'], label='P3T3 Xue Correction', linestyle='-', marker='o', markersize=2.5)
...
plt.title('EI_NOx predictions Steam Injection 5% during entire flight, GTF2035')
plt.xlabel('Time in minutes')
plt.ylabel('EI_NOx (g/ kg Fuel)')
plt.legend()
plt.grid(True)
plt.savefig(f'figures/{flight}/water_injection/correlations/ei_nox_correlations_5.png', format='png')