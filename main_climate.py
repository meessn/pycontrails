...
def run_climate(trajectory, flight_path, engine_model, water_injection, SAF, aircraft, time_bounds, prediction, diurnal, weather_model):
    ...
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/issr/issr_regions_along_flight.png', format='png')
    ...
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/cocip/cocip_ef_flight_path.png', format='png')
    ...
    ax1.legend()
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/cocip/cocip_lw_rf.png', format='png')
    ...
    ax2.legend()
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/cocip/cocip_sw_rf.png', format='png')
    plt.close()
    ...
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/cocip/cocip_ef_evolution.png', format='png')
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/accf_issr/nox_accf.png', format='png')
    ...
    # plt.legend()
    plt.grid(True)
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/accf_issr/contrail_accf.png', format='png')
    ...
    # plt.legend()
    plt.grid(True)
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/accf_issr/contrail_accf_impact.png', format='png')
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/accf_sac/nox_accf.png', format='png')
    ...
    # plt.legend()
    plt.grid(True)
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/accf_sac/contrail_accf.png', format='png')
    ...
    # plt.legend()
    plt.grid(True)
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/accf_sac/contrail_accf_impact.png', format='png')
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'main_results_figures/figures/{trajectory}/{flight}/climate/{prediction}/{weather_model}/accf_sac/nox_co2_impact.png', format='png')
